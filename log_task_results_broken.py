...
A lightweight scr    # Write the row with file locki    # Create file with headers if it doesn't exist
    # Note: Final header check will be done inside the locked section prevent race conditions
    max_retries = 10
    retry_delay = 0.1
    ...
    return Falsesk summary logging to existing calculation workflows.
